...
class PhotoUserSignUpForm extends React.Component {
  state = {
     firstname: "",
     lastname: "",
     username: "",
    ...
    return(
      <Form onSubmit={this.handleLoginSubmit}>
        <Form.Field>
          ...
          <input type="text" value={this.state.username} onChange={this.handleChange} placeholder="Username/Profile Handle" name="username"></input> <br /> <br />
  ...
  handleLoginSubmit = (event) => {
    ...
    this.props.signUp({ photographer: {
